...
<div className="row">
  <div className="col">
    <div className="card" style={{ width: "20rem", padding:"15px",marginLeft:"10px" }}>
      <img src={Article4} className="card-img-top" alt="..." />
  ...
  <div className="col">
    <div className="card" style={{ width: "21rem", padding:"15px" ,marginBottom:"10px",marginLeft:"5px",height:"97vh"}}>
  ...
  <div className="col">
    <div className="card" style={{ width: "20rem", padding:"15px",marginLeft:"15px"}}>
      ...
      <div className="card-body"style={{ width: "20rem", padding:"15px" ,marginBottom:"10px",marginLeft:"5px",height:"62vh"}}>
        <h5 className="card-title">Change in music industry</h5>
        <span><p className="card-text" style={{display:"flex",alignContent:"center",justifyContent:"center",marginBottom:"10px"}}>
  ...
  <div className="col">
    <div className="card" style={{ width: "20rem", padding:"15px" ,marginBottom:"10px",marginLeft:"5px",height:"97vh"}}>
      <img src={Article3} className="card-img-top3" style={{height:"50vh"}} alt="..." />
      <div className="card-body">
        <h5 className="card-title">Live your life on you terms</h5>
        <p className="card-text">
